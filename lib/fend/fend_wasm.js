...
*/
export function initialiseWithHandlers(currency_data) {
...
* @returns {string}
*/
export function evaluateFendWithTimeout(input, timeout) {
    try {
...
* @returns {string}
*/
export function evaluate_fend_with_timeout(input, timeout) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(input, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
        const len0 = WASM_VECTOR_LEN;
...
* @returns {string}
*/
export function evaluateFendWithTimeoutMultiple(inputs, timeout) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {string}
*/
export function evaluateFendWithVariablesJson(input, timeout, variables) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(input, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
        const len0 = WASM_VECTOR_LEN;
...
* @returns {string}
*/
export function substituteInlineFendExpressions(input, timeout) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(input, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
        const len0 = WASM_VECTOR_LEN;
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('fend_wasm_bg.wasm', import.meta.url);
    }
    const imports = getImports();
